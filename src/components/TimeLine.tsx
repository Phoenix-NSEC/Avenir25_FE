              ...
              >
                ...
                <div className="absolute left-4 lg:left-1/2 top-10 transform -translate-x-1/2 lg:-translate-x-1/2 w-6 h-6 flex items-center justify-center">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="size-6 rounded-full bg-gradient-to-br from-purple-600 to-cyan-400 z-20 shadow-lg shadow-purple-500/50 flex items-center justify-center text-sm"></div>
                ...
                <div className="flex flex-col lg:flex-row">
                  ...
                  {index % 2 !== 0 && <div className="hidden lg:block w-1/2" />}
                  ...
                  >
                    ...
                    >
                      ...
                      <h4 className="text-xl font-bold text-white mt-1 mb-3 group-hover:text-purple-100 transition-colors">
                        {item.title}
                      </h4>
